            ...
            <div class="col-md-6 d-flex justify-content-center" id="div-1-2-footer">
                <div class="w-75">
                    ...
                    <ul class="mb-0 list-unstyled">
                        ...
                        <li>
                            <a class="darkest-brown nav-link d-inline" href="#">Alugar/Comprar uma casa</a>
                        </li>
                        <li>
                            <a class="darkest-brown nav-link d-inline" href="{{route('register.user')}}">Registrar sua propriedade no portal</a>
                        </li>
                        <li>
