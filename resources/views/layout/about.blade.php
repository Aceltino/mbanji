    ...
    <nav class="navbar navbar-expand-lg px-4">
        <div class="container-fluid">
            ...
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item">
                <a class="nav-link" href="#">Cadastrar propriedade</a>
                </li>
                <li class="nav-item">
...
<footer class="main-footer mt-5">
    <div class="container-fluid py-2 w-100" id="img-main-footer">
        <div class="d-flex align-items-center mt-5 row" id="div-1-footer">
            <div class="align-items-center col-md-6 col-sm-12 d-flex flex-column" id="div-1-1-footer">
                <img class="w-50" src="../img/footer-logo.png" alt="logo">
                <p class="fs-4 text-white w-50">Encontre seu lar, seu espaço, seu lugar!</p>
            </div>
            <div class="col-md-6 col-sm-12 d-flex justify-content-center" id="div-1-2-footer">
                <div class="w-75 md-">
                    <h2 class="darkest-brown fs-1">Links utéis</h2>
                    <ul class="mb-0 list-unstyled">
                        <li>
                            <a class="darkest-brown nav-link d-inline" href="{{route('about')}}">Sobre o U-MBANJI</a>
                        </li>
                        <li>
                            <a class="darkest-brown nav-link d-inline" href="{{route('buyrent')}}">Alugar/Comprar uma casa</a>
                        </li>
                        <li>
                            <a class="darkest-brown nav-link d-inline" href="{{route('login.user')}}">Registrar sua propriedade no portal</a>
                        </li>
                        <li>
                            <a class="darkest-brown nav-link d-inline" href="#">Termos e Politicas de Privacidade</a>
                        </li>
                    </ul>
                </div>
            </div>
